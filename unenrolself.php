...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'stripepay'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/stripepay/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_stripepay', format_string($course->fullname));
