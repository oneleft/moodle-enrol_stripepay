...
if ($mform->is_cancelled()) {
    ...
    if ($instance->id) {
        ...
        $fields = array('status' => $data->status, 'name' => $data->name, 'customchar1' => $data->customchar1, 'cost' => unformat_float($data->cost),
                        'currency' => $data->currency, 'roleid' => $data->roleid, 'enrolperiod' => $data->enrolperiod,
